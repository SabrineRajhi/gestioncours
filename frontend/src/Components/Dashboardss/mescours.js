...
const MesCours = () => {
  ...
  const userRole = location.state?.userRole || 'etudiant'; // Par défaut étudiant
  ...
  {/* Bouton Ouvrir - visible seulement pour étudiants et enseignants */}
              <td>
  {(userRole === 'etudiant' || userRole === 'enseignant') && (
              ...
              <div className="modal-content">
                <form onSubmit={handleSubmitCours}>
                  ...
                  <div>
                    ...
                    {typeElementId === '5' && <img src="/word-icon.png" alt="Word" />}
