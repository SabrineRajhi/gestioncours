...
public class ElementCours {
    ...
    @JsonIgnoreProperties({"elementsCours"})
    @ManyToOne
    ...
    @JsonIgnoreProperties({"elementsCours"}) // Référence arrière - ne sera pas sérialisée
    @JsonBackReference
 ...
 EspaceCours espaceCours, Element element) {
    ...
    public void setDateLimite(String localDate) { this.dateLimite = localDate; }
